...
import { fetchCourseDescription } from "@/lib/catalog";
...
export default async function CoursePage({ params }: CoursePageProps) {
  ...
  const description = await fetchCourseDescription(course.prefix, course.number);
    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          {description && (
            <p className="mt-2 text-sm text-gray-600 dark:text-green-200/80 max-w-3xl">
              {description}
            </p>
          )}
